...
<div class="container">
    <a href="/admin/profils" class="btn btn-primary mb-3">Kembali</a>
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('profils.update', $profil->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" placeholder="Nama" value="{{$profil->title}}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="" cols="30" rows="10" class="form-control" placeholder="Deskripsi">{{$profil->description}}</textarea>
                </div>
                ...
                <div class="form-group" style="position: relative; border: 1px solid #ced4da;
                    ...
                    <img id="imagePreview" src="/image/{{$profil->image}}" alt="Preview" style="max-width:1000px; min-height:50px; display: block; margin: auto;">
