...
<div class="container">
    <a href="/admin/kegiatans" class="btn btn-primary mb-3">Kembali</a>
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('kegiatans.update', $kegiatan->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" placeholder="Judul" value="{{$kegiatan->title}}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="" cols="30" rows="10" class="form-control" placeholder="Deskripsi">{{$kegiatan->description}}</textarea>
                </div>
                ...
                <div class="form-group" style="position: relative; border: 1px solid #ced4da;
                    ...
                    <img id="imagePreview" src="/image/{{$kegiatan->image}}" alt="Preview" style="max-width:1000px; min-height:50px; display: block; margin: auto;">
